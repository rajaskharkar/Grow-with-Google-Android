...
public class MainActivity extends AppCompatActivity {
    ...
    static final String queryURLKey="queryURL";

    // TODO (2) Create a static final key to store the search's raw JSON
    static final String rawJSONKey="rawJSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            mSearchResultsTextView.setText(savedInstanceState.getString(rawJSONKey));
            mUrlDisplayTextView.setText(savedInstanceState.getString(queryURLKey));
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        String urlTextViewContents=mUrlDisplayTextView.getText().toString();
        outState.putString(queryURLKey, urlTextViewContents);
        String rawJSONTextViewContents=mSearchResultsTextView.getText().toString();
        outState.putString(rawJSONKey, rawJSONTextViewContents);
    }
}