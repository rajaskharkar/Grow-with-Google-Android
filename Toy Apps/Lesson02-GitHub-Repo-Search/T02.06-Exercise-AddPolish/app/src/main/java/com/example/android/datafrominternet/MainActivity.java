...
public class MainActivity extends AppCompatActivity {
    ...
    public void showJsonDataView(TextView data, TextView error){
        data.setVisibility(View.VISIBLE);
        error.setVisibility(View.INVISIBLE);
    }
    // TODO (15) Create a method called showErrorMessage to show the error and hide the data
    public void showErrorMessage(TextView data, TextView error){
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            if (githubSearchResults != null && !githubSearchResults.equals("")) {
                ...
                showJsonDataView(mSearchResultsTextView, errorMessageTextView);
            }
            // TODO (16) Call showErrorMessage if the result is null in onPostExecute
            else{
                showErrorMessage(mSearchResultsTextView, errorMessageTextView);
            }
        }
    }
