...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewGuestNameET=(EditText)findViewById(R.id.person_name_edit_text);
        mNewPartySizeET=(EditText)findViewById(R.id.party_count_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        addGuest(mNewGuestNameET.getText().toString(), partySize);
