...
public class NotificationUtils {
    ...
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID="remainder_notification_channel";
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(
                context, WATER_REMINDER_PENDING_INTENT_ID, startActivityIntent,
