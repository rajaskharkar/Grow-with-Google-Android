...
public class MainActivity extends AppCompatActivity {
    ...
    public void showWeatherDataView(TextView data, TextView error){
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                ...
                showWeatherDataView(mWeatherTextView, errorTextView);
            }
            // TODO (10) If the weather data was null, show the error message
            else{
                showErrorMessage(mWeatherTextView, errorTextView);
            }
        }
    }
