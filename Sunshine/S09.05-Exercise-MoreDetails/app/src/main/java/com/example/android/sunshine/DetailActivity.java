...
//      TODO (28) Display the high temperature
        double highCelc=data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String highString=SunshineWeatherUtils.formatTemperature(this, highCelc);
        mHighTemperatureView.setText(highString);
//      TODO (29) Display the low temperature
        double lowCelc=data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowString=SunshineWeatherUtils.formatTemperature(this, lowCelc);
        mLowTemperatureView.setText(lowString);
//      TODO (30) Display the humidity
        float humidity= data.getFloat(INDEX_WEATHER_HUMIDITY);
        String humidityString=getString(R.string.format_humidity);
